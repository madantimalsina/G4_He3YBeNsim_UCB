...
YBe_PrimaryGeneratorAction::YBe_PrimaryGeneratorAction()
 : G4VUserPrimaryGeneratorAction(),
   ...
   //target_mass(7.5113498694916 * GeV), // calculated by JR (Aug 13, 2021)[ = 4*(m_p+m_n) ] based on the PDG mass
...
void YBe_PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  if(generator_mode == "gammas"){
    ...
    //G4cout <<neutron_energy << ","<< neutron_angle << ", "<< event_position <<G4endl;
                ...
                G4double scatteringAngle, G4double gammaEnergy, G4double nucleusMass)
{
  ...
  //G4double protonMass = G4Proton::Definition()->GetPDGMass();
  //G4double massBe8 = 4.0*(protonMass+protonMass);
  //mystream << "MY CHECK....!!!!  " << "neutronMass  =  " << neutronMass << " MeV/c^2"<< G4endl;
  //G4String buffer = stream.str();
  //frunAction->writetofile(buffer);
/*
  G4cout.precision(20);
  G4cout << "**************************************************************************"<< G4endl;
  G4cout << "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"<<G4endl; 
  G4cout << "MY CHECK....!!!!  " << "neutronMass  =  " << neutronMass << " MeV/c^2"<< G4endl;
  G4cout << "MY CHECK....!!!!  " << "protonMass  =  " << protonMass << " MeV/c^2"<< G4endl;
  G4cout << "MY CHECK....!!!!  " << "target mass (Be-8)  =  " << massBe8 << " MeV/c^2"<< G4endl;
  G4cout << "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"<<G4endl;
  G4cout << "**************************************************************************"<< G4endl;
*/
